...
3. **Summarize** — Tell the user:
   ...
   - Offer the natural post-draft actions: ask for revisions, edit text directly in the browser, or export to PDF

---

## Phase 6: Export to PDF (Optional)

After delivery, ask the user if they want a PDF export. If they decline, stop here.
...
| [scripts/export-pdf.sh](scripts/export-pdf.sh)     | Export slides to PDF                                                 | Phase 6 (export)          |
